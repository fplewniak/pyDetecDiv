...
class ShallowSQLite3(ShallowSQL):
    """
    A concrete shallow SQLite3 database inheriting shallowSQL and implementing SQLite3-specific engine.
    """
