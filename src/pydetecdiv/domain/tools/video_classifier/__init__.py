    ...
    def __init__(self, parameters: Parameters | None = None, working_dir: str | None = None):
        ...
        self.parameters = Parameters(
                [
                    ...
                    FloatParameter(name='focal_gamma', label=f'Focal loss {greek["gamma"]}', default=1.0, minimum=0.0, maximum=2.0, ),
                    ...
                    CheckParameter(name='warmup', label='Warm-up scheduler', default=False, exclusive=True),
