...
def create_model():
    resnet = keras.applications.InceptionV3(input_shape=(75,75,3), weights='imagenet', include_top=False)

    input = keras.Input(shape=(None,75,75,3))
    fold_out, fold_miniBatchSize = SequenceFoldingLayer((75,75,3))(input)
    ...
    unfold = SequenceUnfoldingLayer((1,1,2048))(plugout, fold_miniBatchSize)
