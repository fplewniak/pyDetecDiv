...
def create_model():
    resnet = keras.applications.Xception(input_shape=(71,71,3), weights='imagenet', include_top=False)

    input = keras.Input(shape=(None,71,71,3))
    fold_out, fold_miniBatchSize = SequenceFoldingLayer((71,71,3))(input)
